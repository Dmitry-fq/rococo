...
public class UserdataExceptionHandler {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(UserdataExceptionHandler.class);

    @Value("${api.version}")
    private String apiVersion;

    @GrpcExceptionHandler(UserdataNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public StatusRuntimeException handleUserdataNotFoundException(UserdataNotFoundException ex) {
