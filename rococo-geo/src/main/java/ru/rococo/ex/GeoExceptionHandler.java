...
public class GeoExceptionHandler {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(GeoExceptionHandler.class);
    ...
    public StatusRuntimeException handleCountryNotFoundException(CountryNotFoundException ex) {
